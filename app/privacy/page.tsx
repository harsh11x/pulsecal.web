          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-2xl font-semibold text-foreground">
                ...
                1. Strict Liability Disclaimer
              </h2>
              <div className="bg-destructive/10 border border-destructive/20 p-4 rounded-md text-destructive-foreground">
                <p className="font-bold mb-2">IMPORTANT NOTICE FOR ALL USERS (PATIENTS AND DOCTORS)</p>
                <p>
                  PulseCal is a technology platform that connects patients with independent healthcare providers ("Doctors").
                  PulseCal is <strong>NOT</strong> a medical provider, and we do <strong>NOT</strong> practice medicine or provide medical advice.
                </p>
                <ul className="list-disc ml-6 mt-2 space-y-1">
                  <li><strong>Doctor Responsibility:</strong> The Doctor acts as an independent practitioner. Any diagnosis, treatment, prescription, or medical advice provided is solely the responsibility of the Doctor. PulseCal assumes <strong>NO LIABILITY</strong> for any medical outcomes, malpractice, misdiagnosis, or side effects resulting from the Doctor's actions or prescriptions.</li>
                  <li><strong>Prescriptions:</strong> Prescriptions issued through PulseCal are generated by the Doctor based on their professional judgment. PulseCal does not verify the content or appropriateness of these prescriptions.</li>
                  <li><strong>Patient Choice:</strong> Patients are responsible for verifying the credentials and suitability of any Doctor they choose to consult.</li>
                  <li><strong>Platform Role:</strong> PulseCal's role is strictly limited to providing the software interface for booking, video conferencing, and record-keeping.</li>
                </ul>
              </div>
            </section>
