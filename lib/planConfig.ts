...
export const PLANS = PLAN_ORDER.map((id) => ({
  ...
  limit: id === "STARTER" ? "Up to 3 Doctors" : id === "PROFESSIONAL" ? "Up to 10 Doctors" : "Unlimited Doctors",
  description: id === "STARTER" ? "Perfect for individual practitioners starting out." : id === "PROFESSIONAL" ? "Ideal for growing clinics with multiple staff." : "For large hospitals and multi-location chains.",
